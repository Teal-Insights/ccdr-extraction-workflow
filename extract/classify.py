...
def filter_and_prioritize_links(
    ...
    downloadable = [
        link for link in download_links if link["classification"]["should_download"]
    ]
...
def log_classification_results(
    ...
    log_entry = {
        ...
        "downloadable_links": len(
            [l for l in download_links if l["classification"]["should_download"]]
        ),
        "skipped_links": len(
            [l for l in download_links if not l["classification"]["should_download"]]
        ),
